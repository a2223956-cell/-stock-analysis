...
def fetch_eastmoney_fund_flow(code):
    ...
    urls = [
        f"https://push2his.eastmoney.com/api/qt/stock/fflow/daykline/get?secid={prefix}.{code}&fields1=f1,f2,f3&fields2=f51,f52,f53,f54,f55,f56,f57,f58,f59,f60,f61,f62,f63&lmt=20",
        f"https://push2his.eastmoney.com/api/qt/stock/fflow/daykline/get?lmt=20&klt=101&secid={prefix}.{code}&fields1=f1,f2,f3&fields2=f51,f52,f53,f54,f55,f56",
    ]
...
def call_sector_analysis(code, name=""):
    ...
    script_path = os.path.expanduser("~/.hermes/skills/mx-moni/scripts/sector_analysis.py")
...
def call_news_analysis(code, name=""):
    ...
    script_path = os.path.expanduser("~/.hermes/skills/a-stock-data/scripts/news_analysis.py")
    if not os.path.exists(script_path):
